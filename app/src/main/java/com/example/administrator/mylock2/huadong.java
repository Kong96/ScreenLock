...
public class huadong extends ListView {
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN: {
                ...
                slidePosition = pointToPosition(HITX, HITY);
            ...
            case MotionEvent.ACTION_MOVE: {
                if (Math.abs(getScrollVelocity()) > SNAP_VELOCITY
                        || (Math.abs(event.getX() - HITX) > mTouchSlop && Math
                        .abs(event.getY() - HITY) < mTouchSlop)) {
                    isSlide = true;
    ...
    public huadong(Context context, AttributeSet attrs, int defStyle) {
